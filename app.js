...
app.get("/teams", (req, res) => {
	// Con esta sintaxis, omitimos el el layout.hbs en la "View teams.hbs". "layout: false" y su variable la pasamos en el render como segundo argumento pa que funcione.
	// const data = {
	// 	layout: false,
	// };
